...
The MCP server exposes **81 snapshot-first tools** (64 under the default `safe` profile; 30 under `readonly`; the 17 os/fs tools need `full` or `UMBRIEL_OS=1`) behind a deployer policy you control:
