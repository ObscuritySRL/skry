...
The MCP server exposes **92 snapshot-first tools** (70 under the default `safe` profile; 36 under `readonly`; the 22 os/fs tools need `full` or `UMBRIEL_OS=1`) behind a deployer policy you control:
