...
The MCP server exposes **82 snapshot-first tools** (64 under the default `safe` profile; 30 under `readonly`; the 18 os/fs tools need `full` or `UMBRIEL_OS=1`) behind a deployer policy you control:
