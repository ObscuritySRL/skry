...
The MCP server exposes **90 snapshot-first tools** (69 under the default `safe` profile; 35 under `readonly`; the 21 os/fs tools need `full` or `UMBRIEL_OS=1`) behind a deployer policy you control:
