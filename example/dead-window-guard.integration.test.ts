...
const parent = User32.CreateWindowExW(0, wide('#32770').ptr!, wide('umbriel-deadwin-parent').ptr!, WS_OVERLAPPEDWINDOW | WS_VISIBLE, 200, 200, 320, 180, 0n, 0n, BigInt(hInstance), null);
