...
const parent = User32.CreateWindowExW(0, wide('#32770').ptr!, wide('umbriel-nonlatin-parent').ptr!, WS_OVERLAPPEDWINDOW | WS_VISIBLE, 100, 100, 360, 160, 0n, 0n, BigInt(hInstance), null);
